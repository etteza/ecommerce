...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><strong>Admin</strong> Profile</div>

                <div class="card-body">
                    <form method="POST" action="{{ Route('admin.profile.update') }}" aria-label="{{ __('Profile Update') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"></label>
                            <input type="hidden" name="image" value="{{ Auth::user()->image }}">
                            <div class="col-md-6">
                              <img src="{{ asset('/') }}public/uploads/{{ Auth::user()->image }}" width="120" alt="">
                            </div>
                        </div>
                        <div class="form-group row">
