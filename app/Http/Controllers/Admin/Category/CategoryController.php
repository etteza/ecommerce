...
class CategoryController extends Controller
{
    ...
    public function storecatgory(Request $request)
    {
        ...
        $category->save();
        $notification=array(
                 'messege'=>'Category Insert Success',
                 'alert-type'=>'success'
                       );
    ...
    public function subcategories()
    {
    	...
    	$subcat=DB::table('subcategories')
    	       ...
    	       ->select('subcategories.*','categories.category_name')->orderBy('subcategories.id','desc')
    	       ->get();
    ...
    public function storesubcat(Request $request)
    {
        ...
        $subCatChack = DB::table('subcategories')->where('category_id',$request->category_id)->where('subcategory_name',$request->subcategory_name)->first();
        if (isset($subCatChack)) {
          $notification=array(
              'messege'=>'Sub Category Inserted Not Success',
              'alert-type'=>'error'
              );
              return Redirect()->back()->with($notification);
        } else {
